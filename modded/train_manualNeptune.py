...
def main():
    ...
    run = neptune.init(
        ...
        api_token='eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS5haSIsImFwaV9rZXkiOiI1YjhiYjQwNC01NWYzLTRlYjgtODgxMS05ODRkNGI3Zjc3MzQifQ=='  # Optional: you can also use NEPTUNE_API_TOKEN as an environment variable
    )
